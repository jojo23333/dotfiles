...
description: Create and edit editable presentation slide decks (`.pptx`) with PptxGenJS, bundled layout helpers, and render or validation utilities. Use when tasks involve building a new PowerPoint deck, recreating slides from screenshots, PDFs, or reference decks, modifying slide content while preserving editable output, adding charts or diagrams, or diagnosing overflow, overlap, and font-substitution issues.
---
